...
public class QqClientLogin extends JFrame implements ActionListener {
	...
	public QqClientLogin() {
		// 处理北部
		URL url=getClass().getResource("tou.png");
		jbl1 = new JLabel(new ImageIcon(url));
		...
		jp2_jtf.setFont(new Font("微软雅黑", Font.PLAIN, 18));
		jp2_jpf.setFont(new Font("微软雅黑", Font.PLAIN, 18));
		jp2_jbl1.setFont(new Font("微软雅黑", Font.PLAIN, 20));
		jp2_jb1.setFont(new Font("宋体", Font.PLAIN, 20));
		jp2_jbl2.setFont(new Font("微软雅黑", Font.PLAIN, 20));
		...
		jp3_jtf1 = new JTextField(12);
		jp3_jtf2 = new JTextField(12);
		jp3_jb1 = new JButton("检查账号");
		jp3_jb2 = new JButton("注册账号");
		jp3_jb2.setEnabled(false);
		jp3_jtf1.addActionListener(this);
		jp3_jbl1.setFont(new Font("微软雅黑", Font.PLAIN, 18));
		jp3_jtf1.setFont(new Font("微软雅黑", Font.PLAIN, 18));
		jp3_jtf2.setFont(new Font("微软雅黑", Font.PLAIN, 18));
		jp3_jb1.setFont(new Font("宋体", Font.PLAIN, 18));
		jp3_jbl2.setFont(new Font("微软雅黑", Font.PLAIN, 18));
		jp3_jb2.setFont(new Font("宋体", Font.PLAIN, 18));
		jp3_jtf1.addKeyListener(new NumericKeyListener());
		jp3_jtf2.addKeyListener(new PassWordKeyListener());
		jp3.add(jp3_jbl1);
		jp3.add(jp3_jtf1);
		jp3.add(jp3_jbl2);
		jp3.add(jp3_jtf2);
		...
		// 处理南部
		jp1 = new JPanel();
		jp1_jb1 = new JButton(new ImageIcon(getClass().getResource("denglu.png")));
		// 响应用户点击登录
	...
	public void checkActionPerformed(ActionEvent event) {
		...
		if(Integer.parseInt(jp3_jtf1.getText().trim())>50){
			JOptionPane.showMessageDialog(null, "现在开放的注册号只限于1-50！");
			return;
		}
		boolean flag;
		if (flag=qqClientUser.checkId(u)) {
			JOptionPane.showMessageDialog(this, "账号可以使用");
			jp3_jb2.setEnabled(true);
			jp3_jtf1.setEditable(false);
		} 
		else if(!flag){
			JOptionPane.showMessageDialog(this, "账号重复！");
			jp3_jb2.setEnabled(false);
			jp3_jtf1.setEditable(true);
		}
		else{
			JOptionPane.showMessageDialog(this, "未知错误！注册失败！");
		}
	}
...
//				}
	...
	public class PassWordKeyListener implements KeyListener {
		...
		public void keyTyped(KeyEvent e) {
			// TODO Auto-generated method stub
			int keyChar=e.getKeyChar();
			String s = jp3_jtf2.getText();  
			if(s.length() >= 18) e.consume(); 
			if ((keyChar>=0x30 && keyChar<=0x39)||(keyChar>=0x41 && keyChar<=0x5a)||(keyChar>=0x61 && keyChar<=0x7a)) {
